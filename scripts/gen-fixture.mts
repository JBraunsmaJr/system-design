...
const level1 = {
  ...
  edges: [
    { id: "l1-e1", source: "l1-a", target: "l1-b", data: { label: "reads" } },
  ],
};
...
const toDiagramFile = (serialization as Record<string, unknown>)
  .toDiagramFile as (...args: unknown[]) => Record<string, unknown>;
...
console.log(
  `${version}\t${path}\t${Object.keys(file).length} top-level fields`,
);
